...
import { adminRegisterPayment } from "@/app/actions";
          ...
          <div className="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl relative">
            ...
            <form onSubmit={handleRegisterPayment}>
              <div className="mb-6">
                ...
                <div className="flex justify-end mt-2">
                  <button
                    ...
                    className="text-[10px] font-bold text-emerald-600 hover:text-emerald-700 bg-emerald-50 px-2 py-1 rounded"
                  >
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-stone-900 text-white font-bold py-3.5 rounded-xl hover:bg-black transition-colors disabled:opacity-50 text-xs uppercase tracking-wider"
              >
