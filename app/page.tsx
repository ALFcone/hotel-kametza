"use client"; // Obligatorio para que el menú funcione al pulsar
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-sans text-stone-800 bg-[#FDFBF7] selection:bg-rose-200 selection:text-rose-900">
      ...
      {/* --- HABITACIONES CON ICONOS, DESCRIPCIONES Y SOMBRAS INTENSAS --- */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-2 max-w-5xl mx-auto">
            {groupedRooms.map((room: any) => (
              <div
                key={room.name}
                className="group bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-stone-100 flex flex-col hover:shadow-[0_20px_50px_rgba(112,8,36,0.2)] transition-all duration-500"
              >
                ...
                <div className="p-8 md:p-10 flex flex-col flex-grow">
                  ...
                  <div className="text-stone-500 text-sm mb-8 leading-relaxed font-light">
                    {room.name === "Individual Estándar" && (
                      <p>
                        Diseñada para el viajero que busca eficiencia y confort.
                        Disfrute de una cama de 2 plazas en un entorno privado y
                        silencioso.
                      </p>
                    )}
                    {room.name === "Matrimonial Estándar" && (
                      <p>
                        ...
                        elegantemente decorado con cama de 2 plazas e
                        iluminación cálida.
                      </p>
                    )}
                    {room.name === "Doble Estándar" && (
                      <p>
                        ...
                        camas independientes que garantizan el espacio de cada
                        huésped.
                      </p>
                    )}
                    ...
                    {room.name === "Ejecutiva" && (
                      <p>
                        ...
                        acabados de primera y un escritorio pensado para el
                        trabajo premium.
                      </p>
                    )}
                  </div>
      ...
      <section id="ubicacion" className="py-20 bg-white relative z-10 px-4">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="h-96 w-full bg-stone-200 rounded-3xl overflow-hidden shadow-2xl shadow-stone-300 border-4 border-white">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3885.670691167448!2d-74.22557!3d-13.1610!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDA5JzM5LjYiUyA3NMKwMTMnMzIuMSJX!5e0!3m2!1ses!2spe!4v1700000000000"
              width="100%"
              height="100%"
              style={{ border: 0 }}
